###########################################################################
## Makefile generated for component 'InductionCookerDeploy'. 
## 
## Makefile     : InductionCookerDeploy.mk
## Generated on : Mon Jul 03 17:31:33 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/InductionCookerDeploy.elf
...
PRODUCT_NAME              = InductionCookerDeploy
MAKEFILE                  = InductionCookerDeploy.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2022b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2022b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/alewi/Desktop/UNIVER~1/ESAMII~1/SISTEM~1/Project/REPOSI~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
COMPILER_COMMAND_FILE     = InductionCookerDeploy_comp.rsp
CMD_FILE                  = InductionCookerDeploy.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/InductionCookerDeploy.elf
...
DEFINES_STANDARD = -DMODEL=InductionCookerDeploy -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_digitalIO.o InductionCookerDeploy.o InductionCookerDeploy_data.o mw_mbed_interface.o BufferedSerial.o blapp_support.o SysTickScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/InductionCookerDeploy_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/InductionCookerDeploy_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/InductionCookerDeploy_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/InductionCookerDeploy_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/InductionCookerDeploy_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
InductionCookerDeploy.o : $(START_DIR)/InductionCookerDeploy_ert_rtw/InductionCookerDeploy.c
	$(CC) $(CFLAGS) -o "$@" "$<"


InductionCookerDeploy_data.o : $(START_DIR)/InductionCookerDeploy_ert_rtw/InductionCookerDeploy_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/InductionCookerDeploy_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
